...
const SvgInstagram1SvgrepoCom = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 32 32"
  ...
  >
    <rect
      ...
      height={28}
      rx={6}
      fill="url(#instagram-1-svgrepo-com_svg__a)"
    />
    <rect
      x={2}
      y={2}
      ...
      height={28}
      rx={6}
      fill="url(#instagram-1-svgrepo-com_svg__b)"
    />
    <rect
      x={2}
      y={2}
      ...
      height={28}
      rx={6}
      fill="url(#instagram-1-svgrepo-com_svg__c)"
    />
    ...
    <defs>
      <radialGradient
        id="instagram-1-svgrepo-com_svg__a"
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id="instagram-1-svgrepo-com_svg__b"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
      ...
      <radialGradient
        id="instagram-1-svgrepo-com_svg__c"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
...
export default SvgInstagram1SvgrepoCom;
